...
SemaphoreHandle_t MFRC522_IRQSemaphore;
...
//		OLED_Clear();
		...
		vTaskDelay(1000);
		MFRC522_Request(0x26 ,&back_bits)
...
int main(void)
{
	...
	MFRC522_IRQSemaphore = xSemaphoreCreateBinary( );
